    ...
    <MainContainer>
      <KeyboardAvoidingContainer>
        <VStack style={{
          ...
          <RegularText style={{textAlign: 'center'}}>Enter the 6-digit code sent to your email</RegularText>

          <StyledCodeInput code={resetKey} setCode={setResetKey} maxLength={MAX_CODE_LENGTH} setPinReady={setPinReady}/>
