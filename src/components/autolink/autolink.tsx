...
import {Alert, StyleSheet, StyleProp, Text, TextStyle, TextProps} from 'react-native';
import { truncate } from './truncate';
import { CustomMatch, CustomMatcher } from './custom-match';
      ...
      (linkText: string, match: Match | CustomMatch, index: number) => {
        ...
        return (
          <Text
            ...
            onPress={() => onPress(match as any)}
            onLongPress={() => onLongPress(match as any)}
